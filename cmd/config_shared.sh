...
write_compose_env() {
    ...
    {
        printf '# Generated by fnOS iCloud Sync app settings. Docker Compose reads this file when rebuilding the project.\n'
        printf "wizard_sync_root_path='%s'\n" "$(dotenv_escape "$selected_root")"
        if [ -n "${TRIM_PKGVAR:-}" ]; then
            printf "TRIM_PKGVAR='%s'\n" "$(dotenv_escape "$TRIM_PKGVAR")"
        fi
